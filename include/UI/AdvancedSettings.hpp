...
#ifdef HotReload
DECLARE_CLASS_CUSTOM(ScoreViewer::UI, AdvancedSettings, BSML::HotReloadViewController,
#else
DECLARE_CLASS_CODEGEN(ScoreViewer::UI, AdvancedSettings, HMUI::ViewController,
#endif
